...
<style type="text/css">
.lavish {
	background-image: linear-gradient(to bottom right, #F4C430, white, green);
}
</style>
</head>
<body>
	...
	%>
	<div class="header">
		<nav class="navbar navbar-expand-lg fixed-top  lavish">
		 <a class="navbar-brand" href="<%=ORSView.WELCOME_CTL%>">

		<img src="<%=ORSView.APP_CONTEXT%>/img/custom.png" width="190px"
			height="50px"> </a>
		<button class="navbar-toggler " type="button" classs="dropdown-toggle dropdown-toggle-split" data-toggle="collapse"
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="nav navbar-nav ml-auto"><!-- spaccing ml auto se h -->
				...
				<li class="nav-item dropdown"
					...
					class="nav-link dropdown-toggle dropdown-toggle-split" href="#" id="navbarDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						...
						<i class="fas fa-sign-in-alt"><b> Login</b></i></a> <a
